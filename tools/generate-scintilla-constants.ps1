...
$RequiredNames = @(
    ...
    "SCI_SETSCROLLWIDTHTRACKING", "SCI_SETELEMENTCOLOUR", "SC_ELEMENT_SELECTION_BACK",
    "SC_ELEMENT_SELECTION_INACTIVE_BACK", "SC_ELEMENT_CARET_LINE_BACK", "SCI_GETFIRSTVISIBLELINE",
